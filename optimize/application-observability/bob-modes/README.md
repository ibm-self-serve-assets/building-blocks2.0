# 🚀 Step 1: Import Application Observability Custom Bob Mode (via Bob UI)
...
You can directly add the Application Observability mode.

### 📁 Add Mode Configuration

1. Download and extract `application-observability.zip` file in base-modes folder.
...
-   Select **Application Observability**
...
1. Download and extract `application-observability.zip` file. 
2. Open `.bob/custom_modes.yaml` in the Bob UI editor\
3. Add the Application Observability mode at the end of the file
...
-   Confirm:
    ...
    -   **Application Observability** mode appears
...
-   Application Observability mode will be available in Bob UI.
-   Existing modes will continue to function without disruption.
-   You can start using the mode for **Application Observability**.
