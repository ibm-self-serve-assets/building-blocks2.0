# 🚀 Step 1: Import Automated Resource Management Custom Bob Mode (via Bob UI)

Before using IBM Bob with IBM Turbonomic, you need to import the **Automated Resource Management custom mode** into your project.
...
You can directly add the Automated Resource Management mode.
...
-   Select **Automated Resource Management**
...
3. Add the Automated Resource Management mode at the end of the file
...
#### Example:
    ...
    # Add Automated Resource Management mode
...
-   Confirm:
    ...
    -   **Automated Resource Management** mode appears
...
-   Automated Resource Management mode will be available in Bob UI.
-   Existing modes will continue to function without disruption.
-   You can start using the mode for **Automated Resource Management**.
